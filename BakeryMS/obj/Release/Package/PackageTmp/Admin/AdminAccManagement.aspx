    ...
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-4 d-flex flex-column gap-1">
                <div class="card">
                    <div class="card-header text-white" style="background-color: #2c3e50; color: white;">
                        <h5 class="my-1">Admin Form</h5>
                    </div>
                    <div class="card-body">
                        <!-- Admin Form Fields -->
                        <asp:Label ID="lblAdminID" runat="server" Text="Admin ID (For Update):"></asp:Label>
                        ...
                        <asp:DropDownList ID="drpAdminStatus" runat="server" CssClass="form-control mb-3">
                            <asp:ListItem>Active</asp:ListItem>
                            <asp:ListItem>Inactive</asp:ListItem>
                        </asp:DropDownList>

                        <asp:Label ID="lblAdminMessage" runat="server" Text="" Visible="false"></asp:Label>

                        <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" CssClass="btn" style="background-color: #2c3e50; color: white"/>
